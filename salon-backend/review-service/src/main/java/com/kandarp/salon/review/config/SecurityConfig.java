package com.kandarp.salon.review.config;
...
import com.kandarp.salon.review.exception.handler.CustomAccessDeniedHandler;
import com.kandarp.salon.review.exception.handler.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
	...
	SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(customizer -> {
			customizer.requestMatchers("/review-service-doc/**").permitAll();
			
			customizer.requestMatchers(HttpMethod.GET,"/api/v1/reviews/**").permitAll();
