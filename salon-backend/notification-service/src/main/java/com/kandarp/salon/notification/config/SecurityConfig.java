...
import com.kandarp.salon.notification.exception.handler.CustomAccessDeniedHandler;
import com.kandarp.salon.notification.exception.handler.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
	...
	SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(customizer -> {
			customizer.requestMatchers("/notification-service-doc/**").permitAll();
