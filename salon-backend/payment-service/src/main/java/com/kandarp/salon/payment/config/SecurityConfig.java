...
import com.kandarp.salon.payment.exception.handler.CustomAccessDeniedHandler;
import com.kandarp.salon.payment.exception.handler.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
	...
	SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(customizer -> {
			customizer.requestMatchers("/payment-service-doc/**","/api/v1/payments/webhook/**").permitAll();
