...
/**
 * Custom AccessDeniedHandler to return RFC 9457-compliant ProblemDetail
...
public class CustomAccessDeniedHandler implements ServerAccessDeniedHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, AccessDeniedException denied) {
        LOGGER.error("Access denied: {}", denied.getMessage(), denied);
        ...
        return writeResponse(exchange, problemDetail, HttpStatus.FORBIDDEN);
    }
