package com.kandarp.salon.serviceoffering.config;
...
import com.kandarp.salon.serviceoffering.exception.handler.CustomAccessDeniedHandler;
import com.kandarp.salon.serviceoffering.exception.handler.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
	...
	SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(customizer -> {
			customizer.requestMatchers("/serviceoffering-service-doc/**","/api/v1/salonservices/images/**").permitAll();
			
			customizer.requestMatchers(HttpMethod.GET,"/api/v1/salonservices/**").permitAll();
