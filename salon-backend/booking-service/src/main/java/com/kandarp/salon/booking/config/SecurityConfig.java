...
import com.kandarp.salon.booking.exception.handler.CustomAccessDeniedHandler;
import com.kandarp.salon.booking.exception.handler.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
	...
	SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(customizer -> {
			customizer.requestMatchers("/booking-service-doc/**").permitAll();
